...
</li>`;o.innerHTML+=n})}const u=document.querySelector(".js-search-form"),f=document.querySelector(".gallery"),l=document.querySelector(".loader");u.addEventListener("submit",s=>{s.preventDefault();const o=s.target.elements.search.value.trim();if(!o)return a.warning({title:"Warning",message:"Please enter a search query",position:"topCenter"});l.style.display="block",m(o).then(t=>{l.style.display="none",t.hits.length===0?a.error({title:"Error",message:"Sorry, there are no images matching your search query. Please try again!",position:"topCenter"}):(p(t.hits,f),new c(".gallery a",{captionsData:"alt",captionDelay:250,captionPosition:"bottom"}).refresh())}).catch(t=>{l.style.display="none",a.error({title:"Error",message:"There was a problem with the fetch operation. Please try again later.",position:"topCenter"}),s.target.reset()})});function m(s){const o="https://pixabay.com",t="/api/",e={key:"42305658-75508782eac06a666c1fb928b",image_type:"photo",orientation:"horizontal",safesearch:"true",q:s},r=`${o}${t}?${new URLSearchParams(e)}`;return fetch(r).then(i=>i.json())}
